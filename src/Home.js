...
function Home() {
        ...
        const [showTop10, setShowTop10] = useState(!1);
        const [newList, setNewList] = useState([]);
        const [showNewList, setShowNewList] = useState(!1);
        const [randoms, setRandoms] = useState([]);
        const [showRandoms, setShowRandoms] = useState(!1);
        ...
        return (<React.Fragment>
                <div className="buttons" data-aos='fade-right'>
                        ...
                        <button className='btn btn-outline-light' id='btn-top-10' onClick={
                                (e) => handleClick(e.target, 'loadRandoms')}>Random Games</button></div>
