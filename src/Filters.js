import React, { useState, useEffect } from 'react'; import 'bootswatch/dist/lux/bootstrap.min.css'; import './Filters.css'; import { Dropdown, DropdownItem, DropdownMenu, DropdownToggle } from 'reactstrap'; import Swal from 'sweetalert2'; import AOS from 'aos';
...
function Filters(props) {
    ...
    const handleFilterClick = () => {
        ...
        axios.request(options).then(response => {
            if (clickedGenre !== '') { var filtData = response.data.filter(function (game) { return game.genre === clickedGenre }) } else { filtData = response.data }
    ...
    return (
        <div className='filters-content'>
            <h1 className='decapitalize search' data-aos='fade-down'>Search for Any Game</h1><h2 data-aos='fade-down' className='decapitalize search'>With this filters</h2><div className='filter-dropdowns' data-aos='slide-right'><div className="filter-genre">
